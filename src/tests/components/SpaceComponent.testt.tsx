...
describe('Space component test suite', () => {
    ...
    describe('With photo URL', () => {
        beforeEach(() => {
            setUpTests(<SpaceComponent location={'someLocation'}
                name={'someName'}
...
// outros testes: https://github.com/barosanuemailtest/space-finder-frontend/commit/d8e812d472d7bc261b74339a7c98d0ac5f3d8b71